...
import com.example.personalcenter.adapter.VideoListAdapter;
import com.example.personalcenter.bean.VideoBean;
...
//        db = DBUtils.getInstance(VideoListActivity.this);
        if (ActivityCompat.checkSelfPermission(ParticularsActivity.this, Manifest.permission.INTERNET) !=
                PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(ParticularsActivity.this,new String[]{Manifest.permission.INTERNET},1);
        }else {
            initData();
            init();
        }
...
//                    }
                    // 跳转到视频播放界面
                    Intent intent=new Intent(ParticularsActivity.this,VedioActivity.class);
